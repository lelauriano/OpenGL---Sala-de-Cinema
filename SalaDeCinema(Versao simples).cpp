...
// Removemos setupLighting e setMaterial pois sem GL_LIGHTING eles não têm efeito
...
void drawDoor() {
    drawBox(-9.9f, 2.5f, 8.0f, 0.15f, 5.0f, 2.5f, 0.1f, 0.1f, 0.1f);
    drawBox(-9.82f, 2.3f, 8.0f, 0.1f, 0.1f, 2.3f, 0.7f, 0.7f, 0.7f);
    drawBox(-9.85f, 5.3f, 8.0f, 0.12f, 0.6f, 1.3f, 0.0f, 0.0f, 0.0f);
...
void init() {
    ...
    glEnable(GL_DEPTH_TEST);
    // GL_LIGHTING FOI REMOVIDO DAQUI
